...
(function() {
  ...
  this.get = function(taxon, options) {
    ...
    var genusColor = gimmeColor(taxon);
  ...
  // Copied from https://stackoverflow.com/questions/14733374/how-to-generate-md5-file-hash-on-javascript
